...
<MetaTags
  ...
  openGraph={{
    type: 'website',
    url: 'https://svelte-boxicons.codewithshin.com/',
    title: 'Svelte Boxicons',
    description: 'Boxicon set for Svelte',
    images: [
      {
        url: 'https://open-graph-vercel.vercel.app/api/svelte-boxicons',
        width: 1200,
        height: 630,
        alt: 'Svelte Boxicons'
      }
    ],
    siteName: 'Svelte Boxicons'
  }}
  twitter={{
    handle: '@shinokada',
    ...
    title: 'Svelte Boxicons',
    description: 'Boxicon set for Svelte',
    image: 'https://open-graph-vercel.vercel.app/api/svelte-boxicons',
...
<div class="max-h-screen overflow-auto relative w-full" id="svelte">
  <header
    class="sticky top-0 z-40 flex-none w-full mx-auto bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-cyan-950"
  >
  ...
  <Footer footerType="logo" class="dark:bg-cyan-950">
    <div class="sm:flex sm:items-center sm:justify-between">
      ...
      >
        ...
        <FooterLink href="https://github.com/shinokada/svelte-boxicons/blob/main/LICENSE"
